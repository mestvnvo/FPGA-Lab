...
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { command }]; #IO_L12N_T1_MRCC_14 Sch=sw[4]
...
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { clock }]; #IO_L24P_T3_RS1_15 Sch=led[1]
